...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { content: @memo.content, title: @memo.title, user: @memo.user } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { content: @memo.content, title: @memo.title, user: @memo.user } }
